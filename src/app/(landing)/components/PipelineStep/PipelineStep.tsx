  ...
  return (
    <div className="group relative flex gap-8">
      <div className="flex flex-col items-center">
        <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full border border-cyan-400/30 bg-cyan-400/10 text-lg font-bold text-cyan-400">
          {stepNumber}
        </div>
        <div className="mt-4 h-full w-px bg-gradient-to-b from-cyan-400/30 to-transparent group-last:hidden" />
      </div>
